...
| ----------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | ----------------------------------------- | ----------------------------------- |
| composition | **inset**          | Label incorporation                                                                                                                                   | any                             | root<br />element                         | ![img](docs/input/inset.png)          |
| composition | **overlap**        | Label overlap                                                                                                                                         | any                             | root<br />element                         | ![img](docs/input/overlap.png)        |
| status      | **error**          | Error colorings                                                                                                                                       | any                             | root<br />element,<br />nested<br />input | ![img](docs/input/error.png)          |
| status      | **success**        | Success coloring                                                                                                                                      | any                             | root<br />element,<br />nested<br />input | ![img](docs/input/success.png)        |
| status      | **disabled**       | Disabled coloring                                                                                                                                     | any                             | root<br />element,<br />nested<br />input |                                     |
...
| auxiliary   | **clean**          | Removes outline and paddings                                                                                                                          | check inputs<br />radio oinputs | root<br />element                         | ![img](docs/input/clean.png)          |
| auxiliary   | **reverse**        | Reverses input composition                                                                                                                            | any                             | root<br />element                         | ![img](docs/input/reverse.png)        |
| auxiliary   | **required-label** | If*bl-input* contains an required<br />element and has the required-label<br />defined, displays the required-label<br />at the bottom right corner | any                             | root<br />element                         | ![img](docs/input/required-label.png) |
